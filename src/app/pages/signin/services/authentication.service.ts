import { ModelGoogleSignIn } from './../../../_models/model/model-google-signin';
...
export class AuthenticationService {
  ...
  avatarUser$: BehaviorSubject<string> = new BehaviorSubject<string>('./../../../../assets/images/login/no_avatar.png')/**Pegando avatar do gmail */
  ...
  signIn(params: SingIn): Observable<UserCredential> {
     ...
     // console.log("tap: data: ",( <any>d.user.getIdToken()) )
      ...
      this.nameUser$.next(d.user.displayName == null ? 'Hello Pal, you dont have Name in your register yet': d.user.displayName);
       ...
       const localUserToken = new ModelGoogleSignIn(e.user.email, e._tokenResponse.kind,
